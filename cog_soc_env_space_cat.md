...
SIgui $max\_h$ l'estrat de més altitud en un nínxol. Calcularem la fracció de llum que deixa passar un estrat ($lr_h$) amb l'equació (5).
(5)$$
\lambda_h = \left\{ 
\begin{array}{lcc}
...
*/ 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzQ1NTczOTcsMTMzODMxNjE3MywtMT
