...
(11) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
$$\\
fc_{jk} = 1-\frac {\frac{\sum^{g \in C_{gh} \land \exists j (j=g) | g \in C_{gh})}_{g} \sum_{h}^{(h \in E_{gh} \land \exists k (k=h) | k \in C{jk})} b_{gh}}{S}}{max\_d_{jk}} \\
$$
...
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk4MDkwMjMzMywxMzU5NjIxMDEyLDEzND
