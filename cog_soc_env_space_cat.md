...
El simulador es modelarà amb conjunt d'entitats que definirem a continuació:
 ...
 - *Nínxol* (classe Niche). Les característiques d'aquesta entitat són:
   ...
   - Nitidesa del nínxol ien relació a les capacitats de cerca de les espècies que ho necessiten. Valors propers a 1 significa que el nínxol permet una cerca adequada a les habilitats del cercador. A mesura que el valor s'acosta a 0, implica que el nínxol resenta una major dificultat pels cercadors (geografia irregular, boira, olors fortes, etc).  
 ...
 - *Espècie* (classes Autotroph, Heterotroph). En general, totes les espècies comparteixen els següents conceptes i característiques:
...
Pel que fa al reproductiu, es defineix la taxa màxima de fertilitat o percentatge de reproducció per cicle. La capacitat reproductiva real es veurà afectada per la quantitat d'aliment aconseguit durant el cicle. Si la quantitat és màxima també ho serà la fertilitat, però si decau, la fertilitat es veurà afectada reduint-ne l'eficiència.   
  ...
  - Mida de les diferents fraccions de materia morta expressada en quantitat de meteria que la formen.
  - Superficie que ocupen les deferents fraccions de materia morta
   ...
   - Altres característiques importants per preveure l'evolució de l'ecosistema som: la superfície ocupada i la quantitat de biomassa per individu. Ambdues es faran servir per calcular la probabilitat de coincidència entre presa/aliment i  depredador/recol·lector.
...
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDQ4NzY0MTIsODAzMTQxNzM1LC0yMD
...
MzU1LC00OTIxOTc0NjIsLTE0NjAzMTMwNjUsMTY4ODA1MjgwLC
0xMTkyNzk3NzQyLC0xODE3MDA4NzkyLC00MDk3ODU1NTcsLTEz
MzI3OTk0NDNdfQ==
-->